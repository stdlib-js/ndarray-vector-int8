...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-vector-int8/tags). For example,

```javascript
Int8Vector = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-vector-int8@v0.1.1-umd/browser.js' )
```
